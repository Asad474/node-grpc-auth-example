...
export const authServiceService = {
  login: {
    ...
    responseSerialize: (value: LoginResult): Buffer => Buffer.from(LoginResult.encode(value).finish()),
    responseDeserialize: (value: Buffer): LoginResult => LoginResult.decode(value),
  },
} as const;
